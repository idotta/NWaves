...
public static partial class DesignFilter
{
    ...
    {
        return new Remez(order, [0, fp, fa, 0.5], [1, 0.0], [wp, wa]).Design();
    }
    ...
    {
        return new Remez(order, [0, fa, fp, 0.5], [0, 1.0], [wa, wp]).Design();
    }
    ...
    {
        return new Remez(order, [0, fa1, fp1, fp2, fa2, 0.5], [0, 1.0, 0], [wa1, wp, wa2]).Design();
    }
    ...
    {
        return new Remez(order, [0, fp1, fa1, fa2, fp2, 0.5], [1, 0.0, 1], [wp1, wa, wp2]).Design();
    }
