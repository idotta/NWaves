...
public class SavitzkyGolayFilter : FirFilter
{
    ...
    private static double[] MakeKernel(int size, int deriv = 0)
    {
        ...
        if (deriv == 0)
        {
            ...
            {
                case 5:
                    kernel = [-0.08571429, 0.34285714, 0.48571429, 0.34285714, -0.08571429];
                    break;
                case 7:
                    kernel = [ -0.0952381 ,  0.14285714,  0.28571429,  0.33333333,  0.28571429,
                                              0.14285714, -0.0952381 ];
                    break;
                case 9:
                    kernel = [ -0.09090909,  0.06060606,  0.16883117,  0.23376623,  0.25541126,
                                              0.23376623,  0.16883117,  0.06060606, -0.09090909 ];
                    break;
                case 11:
                    kernel = [ -0.08391608,  0.02097902,  0.1025641 ,  0.16083916,  0.1958042 ,
                                               0.20745921,  0.1958042 ,  0.16083916,  0.1025641 ,  0.02097902, -0.08391608 ];
                    break;
                case 13:
                    kernel = [ -7.69230769e-02,  5.55111512e-17,  6.29370629e-02,  1.11888112e-01,
                    ...
                    break;
                case 15:
                    kernel = [ -0.07058824, -0.01176471,  0.03800905,  0.07873303,  0.11040724,
                                               0.13303167,  0.14660633,  0.15113122,  0.14660633,  0.13303167,
                                               0.11040724,  0.07873303,  0.03800905, -0.01176471, -0.07058824 ];
                    break;
                case 17:
                    kernel = [ -0.06501548, -0.01857585,  0.02167183,  0.05572755,  0.08359133,
                    ...
                    break;
                case 19:
                    kernel = [ -0.06015038, -0.02255639,  0.01061477,  0.03936311,  0.06368863,
                    ...
                    break;
                case 21:
                    kernel = [ -0.05590062, -0.02484472,  0.00294214,  0.02745995,  0.04870873,
                    ...
                    break;
                case 23:
                    kernel = [ -0.05217391, -0.02608696, -0.00248447,  0.01863354,  0.03726708,
                    ...
                    break;
                case 25:
                    kernel = [ -0.04888889, -0.02666667, -0.00637681,  0.01198068,  0.0284058 ,
                    ...
                    break;
                case 27:
                    kernel = [ -0.04597701, -0.02681992, -0.0091954 ,  0.00689655,  0.02145594,
                    ...
                    break;
                case 29:
                    kernel = [ -0.04338154, -0.02669633, -0.01124706,  0.00296626,  0.01594364,
                    ...
                    break;
                case 31:
                    kernel = [ -0.04105572, -0.02639296, -0.01274143, -0.00010112,  0.01152796,
        ...
        else if (deriv == 1)
        {
            ...
            {
                case 5:
                    kernel = [0.2, 0.1, 0, -0.1, -0.2];
                    break;
                case 7:
                    kernel = [ 1.07142857e-01,  7.14285714e-02,  3.57142857e-02, 0,
                                            -3.57142857e-02, -7.14285714e-02, -1.07142857e-01 ];
                    break;
                case 9:
                    kernel = [ 6.66666667e-02,  5.00000000e-02,  3.33333333e-02,  1.66666667e-02, 0,
                                            -1.66666667e-02, -3.33333333e-02, -5.00000000e-02, -6.66666667e-02 ];
                    break;
                case 11:
                    kernel = [ 4.54545455e-02,  3.63636364e-02,  2.72727273e-02,  1.81818182e-02,
                                              9.09090909e-03,  0,              -9.09090909e-03, -1.81818182e-02,
                                             -2.72727273e-02, -3.63636364e-02, -4.54545455e-02 ];
                    break;
                case 13:
                    kernel = [ 3.29670330e-02,  2.74725275e-02,  2.19780220e-02,  1.64835165e-02,
                                              1.09890110e-02,  5.49450549e-03,  0             , -5.49450549e-03,
                                             -1.09890110e-02, -1.64835165e-02, -2.19780220e-02, -2.74725275e-02, -3.29670330e-02 ];
                    break;
                case 15:
                    kernel = [ 2.50000000e-02,  2.14285714e-02,  1.78571429e-02,  1.42857143e-02,
                    ...
                    break;
                case 17:
                    kernel = [ 1.96078431e-02,  1.71568627e-02,  1.47058824e-02,  1.22549020e-02,
                    ...
                    break;
                case 19:
                    kernel = [ 1.57894737e-02,  1.40350877e-02,  1.22807018e-02,  1.05263158e-02,
                    ...
                    break;
                case 21:
                    kernel = [ 1.29870130e-02,  1.16883117e-02,  1.03896104e-02,  9.09090909e-03,
                    ...
                    break;
                case 23:
                    kernel = [ 0.01086957,  0.00988142,  0.00889328,  0.00790514,  0.006917  ,
                    ...
                    break;
                case 25:
                    kernel = [ 9.23076923e-03,  8.46153846e-03,  7.69230769e-03,  6.92307692e-03,
                    ...
                    break;
                case 27:
                    kernel = [ 7.93650794e-03,  7.32600733e-03,  6.71550672e-03,  6.10500611e-03,
                    ...
                    break;
                case 29:
                    kernel = [ 6.89655172e-03,  6.40394089e-03,  5.91133005e-03,  5.41871921e-03,
                    ...
                    break;
                case 31:
                    kernel = [ 0.00604839,  0.00564516,  0.00524194,  0.00483871,  0.00443548,
        ...
        else if (deriv == 2)
        {
            ...
            {
                case 5:
                    kernel = [0.28571429, -0.14285714, -0.28571429, -0.14285714, 0.28571429];
                    break;
                case 7:
                    kernel = [ 1.19047619e-01,  0.00000000e+00, -7.14285714e-02, -9.52380952e-02,
                                            -7.14285714e-02,  1.38777878e-17,  1.19047619e-01 ];
                    break;
                case 9:
                    kernel = [ 0.06060606,  0.01515152, -0.01731602, -0.03679654, -0.04329004,
                                            -0.03679654, -0.01731602,  0.01515152,  0.06060606 ];
                    break;
                case 11:
                    kernel = [ 0.03496503,  0.01398601, -0.002331  , -0.01398601, -0.02097902,
                                             -0.02331002, -0.02097902, -0.01398601, -0.002331  ,  0.01398601,  0.03496503 ];
                    break;
                case 13:
                    kernel = [ 0.02197802,  0.01098901,  0.001998  , -0.004995  , -0.00999001,
                                             -0.01298701, -0.01398601, -0.01298701, -0.00999001, -0.004995  ,
                                              0.001998  ,  0.01098901,  0.02197802 ];
                    break;
                case 15:
                    kernel = [ 0.01470588,  0.00840336,  0.00307046, -0.00129282, -0.00468649,
                                             -0.00711054, -0.00856496, -0.00904977, -0.00856496, -0.00711054,
                                             -0.00468649, -0.00129282,  0.00307046,  0.00840336,  0.01470588 ];
                    break;
                case 17:
                    kernel = [ 0.01031992,  0.00644995,  0.00309598,  0.000258  , -0.00206398,
                    ...
                    break;
                case 19:
                    kernel = [ 0.0075188 ,  0.00501253,  0.00280112,  0.00088456, -0.00073714,
                    ...
                    break;
                case 21:
                    kernel = [ 5.64652739e-03,  3.95256917e-03,  2.43692235e-03,  1.09958691e-03,
                    ...
                    break;
                case 23:
                    kernel = [ 0.00434783,  0.00316206,  0.00208922,  0.00112931,  0.00028233,
                    ...
                    break;
                case 25:
                    kernel = [ 0.0034188 ,  0.0025641 ,  0.00178372,  0.00107767,  0.00044593,
                    ...
                    break;
                case 27:
                    kernel = [ 2.73672687e-03,  2.10517452e-03,  1.52414635e-03,  9.93642373e-04,
                    ...
                    break;
                case 29:
                    kernel = [ 0.00222469,  0.00174797,  0.00130657,  0.00090047,  0.00052969,
                    ...
                    break;
                case 31:
                    kernel = [ 1.83284457e-03,  1.46627566e-03,  1.12498736e-03,  8.08979674e-04,
