...
public class TestMathFunctions
{
    ...
    public void TestLinearInterpolationBigStep()
    {
        ...
        Assert.That(interp, Is.EqualTo([5, 12.142857f, 11.142857f, 5.428571f, 2.571429f]).Within(1e-4));
    }
    ...
    public void TestLinearInterpolationSmallStep()
    {
        ...
        Assert.That(interp, Is.EqualTo([5.0f, 4, 4, 4]).Within(1e-4));
    }
    ...
    public void TestPolynomialDivision()
    {
        ...
        Assert.Multiple(() =>
        {
            Assert.That(div[0].Select(d => d.Real), Is.EqualTo([2.0, 0, 0, 1]).Within(1e-10));
            Assert.That(div[0].Select(d => d.Imaginary), Is.EqualTo([0.0, 0, 0, 0]).Within(1e-10));
    ...
    public void TestLpcToLsf()
    {
        ...
        Assert.That(lsf, Is.EqualTo([0.6471242f, 1.29403331f, 1.74836394f, 2.26815244f, 2.62021719f, 3.1415927f]).Within(1e-5));
    }
    ...
    public void TestLsfToLpc()
    {
        ...
        Assert.That(lpc, Is.EqualTo([1, 0.6149f, 0.2899f, 0.5f, -0.0082f, -0.123f]).Within(1e-5));
    }
}