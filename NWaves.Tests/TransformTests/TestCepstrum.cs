...
public class TestCepstrum
{
    ...
    private float[] _input = [1, 5, 2, 30, 110, 60, 205, 1, 2, 30f];
    ...
    public void TestComplexCepstrum()
    {
        ...
        Assert.That(output, Is.EqualTo([ 5.34123949e+00, -6.07112628e-02, -3.81738790e-02,  1.43294733e-01,
    ...
    public void TestRealCepstrum()
    {
        ...
        Assert.That(output, Is.EqualTo([ 5.34123949e+00,  1.31323203e-01,  2.21040651e-01,  6.34689386e-02,
