...
public class TestConvolution
{
    ...
    public void TestFftCrossCorrelation()
    {
        ...
        Assert.That(conv.Samples, Is.EqualTo([1, 8, 20, 21, 18, 24, 19, 7, 2.0f]).Within(1e-5));
    }
    ...
    public void TestInPlaceCrossCorrelation()
    {
        ...
        Assert.That(res, Is.EqualTo([1, 8, 20, 21, 18, 24, 19, 7, 2.0f, 0, 0, 0, 0, 0, 0, 0]).Within(1e-5));
    }

    [Test]
    public void TestImaginaryParts()
    {
        var s1 = new ComplexDiscreteSignal(1, [1, 0.5], [0, -1.5]);
        var s2 = new ComplexDiscreteSignal(1, [1, 0.5], [0, 1.5]);
        ...
        Assert.Multiple(() =>
        {
            ...
            Assert.That(conv.Imag, Is.EqualTo([0, 0, 0]).Within(1e-6));
        });
    }
}
